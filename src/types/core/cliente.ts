export interface Cliente {
  ...
  corrcod?: number;
  subcorr?: number;
  clinom: string;              // ← Nombre principal del cliente
  telefono?: string;
  ...
  clicatlib?: string;
  clitpo?: string;
  clidir?: string;             // ← Dirección principal
  ...
  nombre?: string;             // Alias para clinom
  documento?: string;          // Alias para cliced o cliruc
  direccion?: string;          // Alias para clidir
  email?: string;              // Alias para cliemail
  departamento?: string;       // Alias para clidptnom
  localidad?: string;          // Alias para clilocnom
}
