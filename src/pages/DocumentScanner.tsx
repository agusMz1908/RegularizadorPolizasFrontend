...
import { Upload, FileText, CheckCircle, AlertCircle, Loader2, Eye, Send, Bug, ArrowLeft } from 'lucide-react';
...
const DocumentScanner: React.FC = () => {
  ...
  const processDocument = async () => {
    ...
    try {
      ...
      // Llamar al backend para procesar el documento (TU CÓDIGO ORIGINAL)
      ...
      // Guardar los datos completos para el formulario detallado
  ...
  // Función para mostrar el formulario detallado
  const mostrarFormularioDetallado = () => {
    if (datosCompletos) {
  ...
  // Handlers para el formulario detallado
  ...
  // Si está mostrando detalles, renderizar el formulario completo
  if (mostrandoDetalles && datosCompletos) {
    return (
  ...
  // Vista principal del escáner (tu código original)
  return (
      ...
      {result && (
        <div className="bg-white border rounded-lg p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              onClick={mostrarFormularioDetallado}
